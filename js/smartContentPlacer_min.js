...
ContentPlacer.prototype.addData=function(a){this.dataArray.concat(a);this.findLargestNode_();this.calculateColumns_();this.target.innerHTML="";this.initiated=!1;this.render_()};ContentPlacer.prototype.setDelay=function(a){this.renderDelay=a};
